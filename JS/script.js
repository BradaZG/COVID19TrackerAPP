...
const showGlobalData = (globalData) => {
    ...
    document.getElementById('total-recoveries').innerText = `TOTAL RECOVERIES: ${globalData.recovered}`;
}
...
const showCountryData = (countryData) => {
    ...
    document.getElementById('today-country-deaths').innerText = `NEW DEATHS: ${countryData.todayDeaths}`;
    document.getElementById('active-cases').innerText = `ACTIVE CASES: ${countryData.active}`;
}
